      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input style={styles.input} name="password" placeholder="Password (min 6 chars)"
            type="password" value={form.password} onChange={handleChange} required minLength={6} />
        ...
        <p style={styles.link}>
          ...
          <span style={styles.switchLink} onClick={onSwitch}>Login here</span>
        </p>
      </div>
    </div>
  );
...
const styles = {
  ...
  title:      { textAlign:'center', marginBottom:'1.5rem', color:'#1a237e' },
